   ...
   public  class CustomersLogic : BaseLogic, IABMLogic<Customers>
    {
        ...
        public void deleteCustomer(string id)
        {
            ...
            try
            {
                //siempre luego de realizar un cambio los guardo
                context.SaveChanges();
                Console.WriteLine($"El cliente con ID {id}, fue eliminado satisfactoriamente.");
            }
            catch (DbEntityValidationException ex)
            {
        ...
        public void updateCustomer(string updateThisID, string newContactName)
        {
            var customerUpdate = context.Customers.Find(updateThisID);
            ...
            try
            {
                //siempre luego de realizar un cambio los guardo
                context.SaveChanges();
                Console.WriteLine($"El Contact Name Ahora es:  {newContactName}.");
            }
            catch (DbEntityValidationException ex)
            {
