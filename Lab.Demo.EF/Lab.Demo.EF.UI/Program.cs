...
namespace Lab.Demo.EF.UI
{
    class Program
    {
        ...
        public static void DeleteCustomerFromTable()
        {
            ...
            catch (CustomMyExceptions No_User_Exist)
            {
                Console.WriteLine($"No existe el usuario: {No_User_Exist.Message}");
                Console.WriteLine($"StrackTrace: {No_User_Exist.StackTrace}");
            }
            catch (DbEntityValidationException ex)
            {
        ...
        public static void SelectAllCustomers()
        {
            ...
            {
                Console.WriteLine($"\nID: {item.CustomerID} - Contact Name: {item.ContactName} - Company: {item.CompanyName} - Title: {item.ContactTitle} - Address: {item.Address} - City: {item.City} - Region: {item.Region} - CP: {item.PostalCode} - Country: {item.Country} - Phone: {item.Phone} - Fax: {item.Fax}");
                Console.WriteLine($"*******************************************************************");
            }                    
